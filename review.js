...
var ali = "Teddy";
console.log(ali.charCodeAt(3))
// Using fromCharCode() - make it readable for us :). You'll see!
console.log(String.fromCharCode(100))
// Take your first and last name and concat()
const firstName = "Taieb";
const lastName = "Ouberka";
...
const alien = 'Vanessa';
const lastindex = vanessa.lastIndexOf(alien);
// Can we use length for strings? I don't know, you tell me.
const noWeCantTeo = "but did you try it out though?"
const term = noWeCantTeo.length;
console.log(term);
...
console.log(replaceGokuWithVegeta.replace('my', 'Totally not joking, LOL. JK'));
// Josh has been forgetful lately. Let's help Josh by using search(), and find their right 'wifey'. 
const joshIsLookingForWifey = "WIFEY 1, wifey 2, WiFeY 3, Wifey 4"
const search1 = "wifey"
console.log(joshIsLookingForWifey.search(search1));
...
const words = splitTheBill.split(',');
console.log(words);
...
const lower = angry.toLowerCase();
console.log(lower);
// toUpperCase()
const jahlunSaidToPutSomeRespectToHisName = "jahlun"
jahlunSaidToPutSomeRespectToHisName.toUpperCase();
// substring()
const oper = jahlunSaidToPutSomeRespectToHisName.substring();
...
const word = console.log(city.trim());
console.log(word)
// =================================================
//                     BOOLEAN
// =================================================
...
for (var i = 0; i <= 10; i++){
  console.log("the room has been spinning ....");
}
// Harry said that was so mean of Teo to do Ken dirty like that. Make Teo's vision spin 20 times FOR LOOP.
var word = "Make Teo's vision";
for (x = 0; x <= 20; x++){
  console.log(word);
}
...
for (var i in whateverQueenBeySaid){ 
  console.log(i);
}
// Using (FOR IN LOOP), print the indexes of the array.
const lana = ['l', 'a', 'n', 'a'];
for (var i = 0; i < lana.length; i++) {
  console.log(lana[i]);
}
// USE (FOR OF LOOP)!
...
fruits.splice(1, 2, "grapefruit", "lemon")
console.log(fruits)
...
const exoticFruits = ["ananas", "blueberry", "blackberry"]
const dess = fruits + " " + exoticFruits;
